...
export function DappLauncherButton({ dappUid }: DappLauncherButtonProps) {
    ...
    return (
        <li className="relative">
            <div
                onClick={handleClick}
                className="p-8 hover:backdrop-blur-md hover:bg-white/30 group block w-full overflow-hidden rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100"
            >
